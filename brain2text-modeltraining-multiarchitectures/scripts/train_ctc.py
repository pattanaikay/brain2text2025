...
from src.models.registry import build_encoder, ENCODER_REGISTRY
...
def train_ctc(args):
    ...
    encoder = build_encoder(args.encoder, session_ids=list(session_ids), patch_size=args.patch_size)

...
def train_e2e(args):
    ...
    logger = setup_logging(args.output_dir, log_name="e2e_train_local")
    ...
    try:
        ...
        logger.info("Local training session ended.")
...
def _train_logic(args, logger):
    ...
    # 3. Model
    quantize = not args.no_quantize and device.type == 'cuda'
    ...
    if args.pretrained_encoder and os.path.exists(args.pretrained_encoder):
        ...
        checkpoint_data = torch.load(args.pretrained_encoder, map_location=device, weights_only=True)

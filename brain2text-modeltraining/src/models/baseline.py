...
# Optimization for A100/A40: Disable HF advisory warnings
...
class BITModel(nn.Module):
    def __init__(self, llm_name="lmms-lab/Aero-1-Audio-1.5B", session_ids=None, quantize=True):
        ...
        # PRIMARY FIX: Use SDPA to bypass Flash Attention package requirements
        ...
        # Robustly get LLM hidden dimension (Aero puts it in text_config)
        ...
        # Improved Prompt Template for Aero-1-Audio (Qwen-style)
    ...
    def forward(self, neural_data, labels=None, session_id=None, neural_lengths=None, return_contrastive=True):
        ...
        if labels is not None:
            ...
            label_inputs = self.tokenizer(labels, return_tensors="pt", padding=True, truncation=True, add_special_tokens=False).to(device)
